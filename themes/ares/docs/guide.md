...
主题已内置无障碍访问支持，包括键盘导航、屏幕阅读器优化、焦点指示器等功能。这些功能默认启用，无需配置。

## 主题切换器

主题支持明暗模式切换，会根据系统设置自动选择主题，用户也可以手动切换。用户的选择会保存到本地存储中。

主题切换器默认显示在导航栏中。

## 返回顶部按钮

返回顶部按钮会在用户向下滚动时自动显示在页面右下角，点击后平滑滚动到页面顶部。
